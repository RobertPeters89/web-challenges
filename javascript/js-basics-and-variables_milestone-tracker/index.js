...
const totalDays = 365 * yearsPracticing;
console.log("Total days practiced: " + totalDays);

const dayLeft = (10 - yearsPracticing) * 365;
console.log("Days left to 10 year milestone: " + dayLeft);

const percentage = yearsPracticing * 10;
console.log("Precent of milestone: " + percentage + "%");

console.log("Cumulative number of days: " + totalDays);
